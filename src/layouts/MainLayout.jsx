    ...
    <div className="bg-base-100">
      ...
      <main className="min-h-screen bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Top right accent */}
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-blue-500/10 via-indigo-500/5 to-transparent rounded-full blur-3xl"></div>

          {/* Bottom left accent */}
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-amber-500/10 via-orange-500/5 to-transparent rounded-full blur-3xl"></div>
          ...
          <div className="absolute top-1/4 left-1/3 w-64 h-64 bg-gradient-to-br from-emerald-500/8 to-transparent rounded-full blur-2xl animate-pulse-very-slow"></div>
          <div className="absolute bottom-1/3 right-1/3 w-72 h-72 bg-gradient-to-tl from-purple-500/6 to-transparent rounded-full blur-3xl animate-pulse-slow"></div>
